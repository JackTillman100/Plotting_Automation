...
#Collecting the data we need for the bicone antenna:
bicone_theta_rec = data_dict['ARA_Sym_Bicone_6in']['theta_rec_0']
bicone_nnu_theta = data_dict['ARA_Sym_Bicone_6in']['nnu_theta']
bicone_weights = data_dict['ARA_Sym_Bicone_6in']['weight']

#Collecting the data we need for the 37_16 antenna:
evolved_theta_rec = data_dict['37_16']['theta_rec_0']
evolved_nnu_theta = data_dict['37_16']['nnu_theta']
evolved_weight = data_dict['37_16']['weight']
...
ax1.hist(theta_recHist1,weights=nuWeights, alpha=1.0, bins=numBins,histtype='step', stacked=True,density=False, fill=False,label="Evolved Bicone", linewidth = 2)
ax1.hist(theta_recHist2,weights=nuWeights2, alpha=1.0, bins=numBins,histtype='step', stacked=True,density=False, fill=False,label="ARA Bicone", linewidth = 2)
...
ax1.hist(nnuHist1, weights=nuWeights, bins=numBins, density=False, alpha=1.0,histtype='step',label='Evolved Bicone', linewidth = 2)
ax1.hist(nnuHist2, weights=nuWeights2, bins=numBins, density=False, alpha=1.0,histtype='step',label='ARA Bicone', linewidth = 2)
